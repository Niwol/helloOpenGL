...
// SimpleCamera::SimpleCamera(int width, int height) : OpenGLDemo(width,
// height), _activecamera(0), _camera(nullptr) {
...
//         (GLvoid*)0); glEnableVertexAttribArray(1);
//         // 7. Copy our index array in a element buffer for OpenGL to use
//         glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, _ebo);
//         glBufferData(GL_ELEMENT_ARRAY_BUFFER, _indices.size()*sizeof
//         (GLfloat), _indices.data(), GL_STATIC_DRAW);
//     //6. Unbind the VAO
//     glBindVertexArray(0);
...
//     _cameraselector.push_back( []()->Camera*{return new
//     EulerCamera(glm::vec3(0.f, 0.f, 3.f));} ); _cameraselector.push_back(
//     []()->Camera*{return new TrackballCamera(glm::vec3(0.f, 0.f, 3.f));} );
...
//     _projection = glm::perspective(glm::radians(_camera->zoom()),
...
//     glm::value_ptr(_model)); glUniformMatrix4fv(
//     glGetUniformLocation(_program, "view"), 1, GL_FALSE,
//     glm::value_ptr(_view)); glUniformMatrix4fv(
//     glGetUniformLocation(_program, "projection"), 1, GL_FALSE,
